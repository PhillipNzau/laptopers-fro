...
_TeleportService.ɵfac = function TeleportService_Factory(__ngFactoryType__) {
...
_TeleportDirective.ɵfac = function TeleportDirective_Factory(__ngFactoryType__) {
...
_TeleportOutletDirective.ɵfac = function TeleportOutletDirective_Factory(__ngFactoryType__) {
...
_ViewService.ɵfac = function ViewService_Factory(__ngFactoryType__) {
...
_DynamicViewComponent.ɵfac = function DynamicViewComponent_Factory(__ngFactoryType__) {
...
_DynamicViewDirective.ɵfac = function DynamicViewDirective_Factory(__ngFactoryType__) {
...
function IndicatorComponent_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtext(4, "\n      ");
    ɵɵconditionalCreate(5, IndicatorComponent_Conditional_0_Conditional_5_Case_5_Template, 6, 1)(6, IndicatorComponent_Conditional_0_Conditional_5_Case_6_Template, 6, 1)(7, IndicatorComponent_Conditional_0_Conditional_5_Case_7_Template, 6, 1)(8, IndicatorComponent_Conditional_0_Conditional_5_Case_8_Template, 6, 1);
    ɵɵtext(9, "\n    ");
    ɵɵelementEnd();
    ɵɵtext(10, "\n  ");
    ɵɵelementEnd();
...
function IndicatorComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtext(4, "\n  ");
    ɵɵconditionalCreate(5, IndicatorComponent_Conditional_0_Conditional_5_Template, 12, 1);
    ɵɵelementEnd();
    ɵɵtext(6, "\n");
  }
  if (rf & 2) {
...
function HotToastComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtext(0, " ");
    ɵɵconditionalCreate(1, HotToastComponent_Conditional_9_Conditional_1_Template, 4, 2)(2, HotToastComponent_Conditional_9_Conditional_2_Template, 6, 1);
  }
  if (rf & 2) {
...
_CheckMarkComponent.ɵfac = function CheckMarkComponent_Factory(__ngFactoryType__) {
...
_WarningComponent.ɵfac = function WarningComponent_Factory(__ngFactoryType__) {
...
_IndicatorComponent.ɵfac = function IndicatorComponent_Factory(__ngFactoryType__) {
...
_IndicatorComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function IndicatorComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵconditionalCreate(0, IndicatorComponent_Conditional_0_Template, 7, 2);
    }
    if (rf & 2) {
...
_AnimatedIconComponent.ɵfac = function AnimatedIconComponent_Factory(__ngFactoryType__) {
...
_HotToastComponent.ɵfac = function HotToastComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _HotToastComponent)(ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone));
};
_HotToastComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function HotToastComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵelementEnd();
      ɵɵtext(19, "\n\n      ");
      ɵɵconditionalCreate(20, HotToastComponent_Conditional_20_Template, 3, 1);
      ɵɵelementEnd();
      ɵɵtext(21, "\n  ");
      ɵɵelementEnd();
      ɵɵtext(22, "\n");
...
_HotToastContainerComponent.ɵfac = function HotToastContainerComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _HotToastContainerComponent)(ɵɵdirectiveInject(ChangeDetectorRef));
};
...
_HotToastService.ɵfac = function HotToastService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _HotToastService)(ɵɵinject(ViewService), ɵɵinject(PLATFORM_ID), ɵɵinject(ToastConfig, 8));
};
